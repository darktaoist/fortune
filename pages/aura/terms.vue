<script setup>
// AURA 앱 이용약관 — 1.0 AuraTerms.vue 포팅.
// 4개국어: prose 본문은 단일 HTML 키(aura.terms.body), 헤더/푸터는 nav 키.
definePageMeta({ layout: false })
const { t } = useI18n()
const localePath = useLocalePath()
useSeoMeta({ title: () => t('aura.terms.seoTitle'), robots: 'noindex, nofollow' })
...
<template>
  <div class="legal-page">
    ...
    <div class="legal-header">
      ...
      <h1>{{ t('aura.terms.h1') }}</h1>
      <span class="app-badge">{{ t('aura.legal.badge') }}</span>
    </div>

    <div class="legal-body" v-html="t('aura.terms.body')"></div>
